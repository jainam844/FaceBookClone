...
import PostCardHeader from "../../components/Section/DisplayPost/PostCardHeader";
import PostImageSection from "../../components/Section/DisplayPost/PostImageSection";
import PostCardContent from "../../components/Section/DisplayPost/PostCardContent";
import PostCardActions from "../../components/Section/DisplayPost/PostCardAction";
...
const PostDisplay: React.FC<PostProps> = ({ post, reference, onClearPost }) => {
